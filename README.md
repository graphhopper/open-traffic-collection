...
* UNECE Traffic Census (updated every 5 years), showing AADT for segments of E-Roads within the UNECE region [UNECE traffic census map](https://unece.org/traffic-census-map)
