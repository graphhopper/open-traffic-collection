...
* Germany:
  * [Entire Germany](https://www.opendata-oepnv.de/ht/de/datensaetze), (work-)daily GTFS and NeTeX extracts from the DELFI integration platform [DIP](https://www.delfi.de). GTFS currently only comprises 12 of 16 federal states. CC-BY 4.0. There is also the public transport stop registry ('Zentrales Haltestellenverzeichnis' (ZHV)). [stable urls](https://github.com/juliuste/opendata-oepnv#datasets)
